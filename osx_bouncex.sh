...
sudo scutil --set ComputerName "Wingtip iMac10"
sudo scutil --set HostName "Wingtip-iMac10"
sudo scutil --set LocalHostName "Wingtip-iMac10"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Wingtip-iMac10"
